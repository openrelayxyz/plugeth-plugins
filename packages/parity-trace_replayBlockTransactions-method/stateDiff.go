...
func (pt *ParityTrace) StateDiffVariant(ctx context.Context, bkNum string) ([]map[string]*LayerTwo, error) {
	...
	var result []map[string]*LayerTwo
	for _, object := range sds {
		result = append(result, object.ReturnObj)
	}
