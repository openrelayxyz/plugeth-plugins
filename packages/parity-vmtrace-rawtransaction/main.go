	...
	return []core.API{
		{
			Namespace: "trace",
			Version:   "1.0",
			Service:   &ParityVMTrace{backend: backend, stack: stack},
			Public:    true,
		},
	}
}
...
func (vm *ParityVMTrace) RawTransaction(ctx context.Context, data hexutil.Bytes, tracer []string) (interface{}, error) {
